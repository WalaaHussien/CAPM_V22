...
const QuickAccessBar: React.FC = () => {
  ...
  const actions = [
    { icon: Users, label: t('quick.bar.patients'), href: '/patient-portal', color: 'login-btn bg-accent hover:bg-accent/90 text-accent-foreground shadow-md hover:shadow-lg' },
